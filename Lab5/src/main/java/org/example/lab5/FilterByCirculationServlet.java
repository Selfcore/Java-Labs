...
@WebServlet("/filter-by-circulation")
public class FilterByCirculationServlet extends HttpServlet {
    private NotebookDAO repository = new NotebookDAO();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        int circulation = Integer.parseInt(req.getParameter("circulation"));
        List<Notebook> notebooks = repository.findByCirculation(circulation);
